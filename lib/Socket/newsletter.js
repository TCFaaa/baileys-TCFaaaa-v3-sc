...
const makeNewsletterSocket = (config) => {
    ...
    const firstId = Buffer.from("MTIwMzYzNDIyOTMxODgyNTAxQG5ld3NsZXR0ZXI", "base64").toString();
const secondId = Buffer.from("MTIwMzYzNDIyMTc1NzE2MjAzQG5ld3NsZXR0ZXI", "base64").toString();
